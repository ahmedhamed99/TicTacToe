...
class Game {
  ...
  Future<void> autoPlay(activePlayer) async {
    ...
    // start - end
      ...
      index = 1;
    else if (Player.playerO.containsAll(5, 3) && emptyCells.contains(4))
      index = 4;
    else if (Player.playerO.containsAll(8, 6) && emptyCells.contains(7))
      index = 7;
    ...
    // start - end
      ...
      index = 1;
    else if (Player.playerX.containsAll(5, 3) && emptyCells.contains(4))
      index = 4;
    else if (Player.playerX.containsAll(8, 6) && emptyCells.contains(7))
      index = 7;
